...
${OBJECTDIR}/FingerPrintBridgeLib.o: FingerPrintBridgeLib.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I/usr/include/libusb-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I../Libs/Downloads/jdk1.8.0_131/include -I../Libs/Downloads/jdk1.8.0_131/include/linux -I../Libs/Downloads/libfprint-0.7.0 -I../Libs/Downloads/libfprint-0.7.0/libfprint -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FingerPrintBridgeLib.o FingerPrintBridgeLib.c
