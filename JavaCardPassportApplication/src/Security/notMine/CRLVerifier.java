...
public class CRLVerifier {
     ...
     * @throws CertificateValidationException if the certificate is revoked
     */
    public static void verifyCertificateCRLs(X509Certificate cert)
        ...
        try {
            ...
            if (ex instanceof CertificateValidationException) {
                throw (CertificateValidationException) ex;
            } else {
                throw new CertificateValidationException(
    ...
    private static X509CRL downloadCRL(String crlURL) throws IOException,
            ...
            CertificateValidationException, NamingException {
