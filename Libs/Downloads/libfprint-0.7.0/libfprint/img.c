...
//Modified: Add API_EXPORTED
API_EXPORTED struct fp_img *fpi_img_new_for_imgdev(struct fp_img_dev *imgdev)
{
...
//Modified: Add API_EXPORTED
API_EXPORTED int fpi_img_to_print_data(struct fp_img_dev *imgdev, struct fp_img *img,
