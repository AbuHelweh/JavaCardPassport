...
set LDAP_JAR=%LDAPTIVE_HOME%\jars\ldaptive-1.2.3.jar
set LIBDIR=%LDAPTIVE_HOME%\lib

set CLASSPATH=%LIBDIR%\commons-cli-1.4.jar;%LIBDIR%\slf4j-api-1.7.25.jar;%LDAP_JAR%

call "%JAVA%" -cp "%CLASSPATH%" org.ldaptive.cli.CompareOperationCli %*
goto end
